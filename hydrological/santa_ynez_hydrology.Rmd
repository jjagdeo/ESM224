...
syll_graph <- ggplot(santa_ynez_los_laurls, aes(x = date, y = discharge_m3_s)) +
  ...
  labs(x = "Date",
       y = "Discharge (cumecs)") +
  ggtitle("Santa Ynez Los Laureles (11123500)")
...
scsy_graph <- ggplot(santa_cruz_santa_ynez, aes(x = date, y = discharge_m3_s)) +
  ...
  labs(x = "Date",
       y = "Discharge (cumecs)") +
  ggtitle("Santa Cruz Santa Ynez (11124500)")
...
sys_graph <- ggplot(santa_ynez_solvang, aes(x = date, y = discharge_m3_s)) +
  ...
  labs(x = "Date",
       y = "Discharge (cumecs)") +
  ggtitle("Santa Ynez Solvang (11128500)")
...
ap_graph <- ggplot(alamo_pintado, aes(x = date, y = discharge_m3_s)) +
  ...
  labs(x = "Date",
       y = "Discharge (cumecs)") +
  ggtitle("Alamo Pintado (11128250)")
...
zb_graph <- ggplot(zaca_buellton, aes(x = date, y = discharge_m3_s)) +
  ...
  labs(x = "Date",
       y = "Discharge (cumecs)") +
  ggtitle("Zaca Buellton (11129800)")
